...
public class MekanismRecipes {
		...
		public static void addRecipes () {
				...
				r.addShaped(new ItemStack(MekanismItems.FilterCard, 1, 0), " R ", "XAX", " R ", 'R', Blocks.redstone_block, 'X', "packGlass", 'A', "dye");
				...
				r.addShaped(new ItemStack(MekanismItems.FilterCard, 1, 0), " X ", "XAX", " X ", 'X', new ItemStack(MekanismItems.ReinforcedAlloy), 'A', new ItemStack(MekanismItems.ControlCircuit, 1, 0));
