...
public class ElectroMagicRecipes {
		...
		public static void addRecipes () {
				...
				ThaumcraftHelper.addShaped("Thaumium Reinforced Wings", new ItemStack(ItemRegistry.thaumiumWing, 1, 27), new AspectList().add(Aspect.AIR, 50).add(Aspect.EARTH, 50).add(Aspect.ENTROPY, 50), "FXA", "FXA", "FXA", 'F', new ItemStack(ItemRegistry.materials, 1, 13), 'X', new ItemStack(ConfigItems.itemResource, 1, 2), 'A', TFCItems.redSteelSheet2x);
				ThaumcraftHelper.addShaped("Thaumium Reinforced Wings", new ItemStack(ItemRegistry.thaumiumWing, 1, 27), new AspectList().add(Aspect.AIR, 50).add(Aspect.EARTH, 50).add(Aspect.ENTROPY, 50), "FXA", "FXA", "FXA", 'F', new ItemStack(ItemRegistry.materials, 1, 13), 'X', new ItemStack(ConfigItems.itemResource, 1, 2), 'A', TFCItems.blackSteelSheet2x);
				...
				ThaumcraftHelper.addShaped("Compressed Solars", new ItemStack(BlockRegistry.emtSolars, 1, 0), new AspectList().add(Aspect.FIRE, 8).add(Aspect.AIR, 8).add(Aspect.EARTH, 8).add(Aspect.ENTROPY, 8).add(Aspect.WATER, 8), "XXX", "XXX", "XXX", 'X', new ItemStack(IC2Items.getItem("generator").getItem(), 1, 3));
				ThaumcraftHelper.addShaped("Compressed Solars", new ItemStack(BlockRegistry.emtSolars, 1, 1), new AspectList().add(Aspect.FIRE, 8).add(Aspect.AIR, 8).add(Aspect.EARTH, 8).add(Aspect.ENTROPY, 8).add(Aspect.WATER, 8), "XXX", "XXX", "XXX", 'X', new ItemStack(BlockRegistry.emtSolars, 1, 0));
