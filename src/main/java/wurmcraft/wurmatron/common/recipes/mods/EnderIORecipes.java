...
public class EnderIORecipes {
		...
		public static void addRecipes () {
				...
				r.addBasicMachineRecipe(EnderIO.blockCrusher, "packGemExquisitePure", new ItemStack(EnderIO.itemAlloy, 1, 2), WurmTweaksItems.itemMixedSheet, WurmTweaksItems.itemMachineFrame);
				...
				r.addCrossWCenter(new ItemStack(EnderIO.blockCapBank, 1, 1), WurmTweaksBlocks.blockCompressedRedstone, new ItemStack(EnderIO.itemBasicCapacitor, 1, 1), WurmTweaksBlocks.blockGold);
				r.addCrossWCenter(new ItemStack(EnderIO.blockCapBank, 1, 2), new ItemStack(EnderIO.itemBasicCapacitor, 1, 1), new ItemStack(EnderIO.itemBasicCapacitor, 1, 2), WurmTweaksBlocks.blockGold);
				r.addCrossWCenter(new ItemStack(EnderIO.blockCapBank, 1, 3), new ItemStack(EnderIO.itemBasicCapacitor, 1, 2), new ItemStack(EnderIO.itemBasicCapacitor, 1, 2), new ItemStack(EnderIO.itemMaterial, 1, 6));
				r.addBasicMachineRecipe(EnderIO.blockPainter, "packGemExquisitePure", EnderIO.itemAlloy, WurmTweaksItems.ingotPinkSteel, WurmTweaksItems.itemMachineFrame);
				...
				r.addBasicMachineRecipe(EnderIO.blockFarmStation, "packGemExquisitePure", "packSeed", TFCItems.redSteelBucketEmpty, WurmTweaksItems.itemMachineFrame);
				...
				r.addBasicMachineRecipe(EnderIO.blockVat, "packGemExquisitePure", EnderIO.itemAlloy, TFCItems.redSteelSheet2x, "packGlass");
				...
				r.addBasicMachineRecipe(EnderIO.blockInventoryPanel, new ItemStack(EnderIO.itemAlloy, 1, 6), "packGemExquisitePure", EnderIO.blockFusedQuartz, WurmTweaksItems.itemQuantumSingularity);
				...
				r.addShaped(EnderIO.blockEnchanter, "GEG", "III", "I I", 'G', "packGemExquisitePure", 'E', Blocks.enchanting_table, 'I', new ItemStack(EnderIO.itemAlloy, 1, 6));
				...
				r.addShapeless(new ItemStack(EnderIO.itemMaterial, 1, 5), "packGemExquisitePure", WurmTweaksItems.itemMixedSheet, Items.ender_eye);
				r.addShapeless(new ItemStack(EnderIO.itemMaterial, 1, 6), "packGemExquisitePure", WurmTweaksItems.itemMixedSheet);
				r.addShapeless(new ItemStack(EnderIO.itemMaterial, 1, 8), "packGemExquisitePure", Items.ender_pearl);
				r.addCrossWCenter(EnderIO.itemTravelStaff, new ItemStack(EnderIO.itemMaterial, 1, 5), new ItemStack(EnderIO.itemMaterial, 1, 1), "packGemExquisitePure");
