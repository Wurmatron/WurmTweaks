...
public class ComputerCraftRecipes {
		...
		public static void addRecipes () {
				...
				r.addBasicMachineRecipe(new ItemStack(ComputerCraft.Blocks.computer, 1, 16384), WurmTweaksItems.itemComputationalCore, TFCItems.goldSheet2x, TFCItems.platinumSheet, Blocks.glass_pane);
				...
				r.addCircleWCenter(new ItemStack(ComputerCraft.Blocks.peripheral, 1, 1), "packSmoothStone", Items.ender_pearl);
				r.addCircleWCenter(new ItemStack(ComputerCraft.Blocks.cable, 1, 1), "packSmoothStone", Items.redstone);
				...
				r.addShaped(new ItemStack(ComputerCraft.Items.pocketComputer, 1, 0), "SSS", "SAS", "RRR", 'S', "packSmoothStone", 'A', Items.golden_apple, 'R', Items.redstone);
