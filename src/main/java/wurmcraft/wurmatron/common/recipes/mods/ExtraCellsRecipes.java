...
public class ExtraCellsRecipes {
		...
		public static void addRecipes () {
				LogHandler.info("Adding Extra Cells Recipes");
				r.addCircle(ExtraCellsApiInstance.instance.blocks().walrus().maybeStack(1).get(), TFCHelper.getFood(TFCItems.fishRaw, 160));
				r.addShapeless(ExtraCellsApiInstance.instance.blocks().fluidCrafter().maybeStack(1).get(), Api.INSTANCE.blocks().blockMolecularAssembler.stack(1), ExtraCellsApiInstance.instance.parts().partFluidStorageBus().maybeStack(1).get());
				...
				r.addShapeless(ExtraCellsApiInstance.instance.parts().partOreDictExportBus().maybeStack(1).get(), Api.INSTANCE.parts().partExportBus.stack(1), "packIngot");
				r.addShapeless(ExtraCellsApiInstance.instance.parts().partFluidStorageBus().maybeStack(1).get(), Api.INSTANCE.parts().partStorageBus.stack(1), ExtraCellsApiInstance.instance.parts().partFluidTerminal().maybeStack(1).get());
				r.addShapeless(ExtraCellsApiInstance.instance.parts().partFluidTerminal().maybeStack(1).get(), Api.INSTANCE.parts().partTerminal.stack(1), ExtraCellsApiInstance.instance.parts().partFluidStorageBus().maybeStack(1).get());
				r.addShapeless(ExtraCellsApiInstance.instance.parts().partFluidLevelEmitter().maybeStack(1).get(), Api.INSTANCE.parts().partLevelEmitter.stack(1), TDDucts.fluidBasic.itemStack);
				r.addShapeless(ExtraCellsApiInstance.instance.parts().partDrive().maybeStack(1).get(), Api.INSTANCE.blocks().blockDrive.stack(1), WurmTweaksItems.gearMixedSheet);
				r.addShapeless(ExtraCellsApiInstance.instance.parts().partBattery().maybeStack(1).get(), Api.INSTANCE.blocks().blockEnergyCell.stack(1), WurmTweaksItems.gearMixedSheet);
				...
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 0), "PCP", "XAX", "PXP", 'P', WurmTweaksItems.itemQuantumCore, 'C', Api.INSTANCE.materials().materialEngProcessor.stack(1), 'X', Api.INSTANCE.materials().materialCell64kPart.stack(1), 'A', Api.INSTANCE.materials().materialEngProcessor.stack(1));
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 1), "PCP", "XAX", "PXP", 'P', WurmTweaksItems.itemQuantumCore, 'C', Api.INSTANCE.materials().materialEngProcessor.stack(1), 'X', new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 0), 'A', Api.INSTANCE.materials().materialEngProcessor.stack(1));
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 2), "PCP", "XAX", "PXP", 'P', WurmTweaksItems.itemQuantumCore, 'C', Api.INSTANCE.materials().materialEngProcessor.stack(1), 'X', new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 1), 'A', Api.INSTANCE.materials().materialEngProcessor.stack(1));
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 3), "PCP", "XAX", "PXP", 'P', WurmTweaksItems.itemQuantumCore, 'C', Api.INSTANCE.materials().materialEngProcessor.stack(1), 'X', new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 2), 'A', Api.INSTANCE.materials().materialEngProcessor.stack(1));
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 4), "ISI", "SPS", "ISI", 'I', TFCItems.blueSteelIngot, 'S', TFCItems.redSteelSheet, 'P', Api.INSTANCE.materials().materialEngProcessor.stack(1));
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 5), "SES", "XGX", "SXS", 'S', WurmTweaksItems.itemQuantumCore, 'E', Api.INSTANCE.materials().materialEngProcessor.stack(1), 'G', "packGlass", 'X', new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 4));
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 6), "SES", "XGX", "SXS", 'S', WurmTweaksItems.itemQuantumCore, 'E', Api.INSTANCE.materials().materialEngProcessor.stack(1), 'G', "packGlass", 'X', new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 5));
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 7), "SES", "XGX", "SXS", 'S', WurmTweaksItems.itemQuantumCore, 'E', Api.INSTANCE.materials().materialEngProcessor.stack(1), 'G', "packGlass", 'X', new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 6));
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 8), "SES", "XGX", "SXS", 'S', WurmTweaksItems.itemQuantumCore, 'E', Api.INSTANCE.materials().materialEngProcessor.stack(1), 'G', "packGlass", 'X', new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 7));
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 9), "SES", "XGX", "SXS", 'S', WurmTweaksItems.itemQuantumCore, 'E', Api.INSTANCE.materials().materialEngProcessor.stack(1), 'G', "packGlass", 'X', new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 8));
				r.addShaped(new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 10), "SES", "XGX", "SXS", 'S', WurmTweaksItems.itemQuantumCore, 'E', Api.INSTANCE.materials().materialEngProcessor.stack(1), 'G', "packGlass", 'X', new ItemStack(ItemEnum.STORAGECOMPONET.getItem(), 1, 9));
				...
				r.addShapeless(new ItemStack(ItemEnum.PHYSICALSTORAGE.getItem(), 1, 4), Api.INSTANCE.materials().materialCell1kPart.stack(1), Api.INSTANCE.materials().materialEmptyStorageCell.item(), "packChest");
