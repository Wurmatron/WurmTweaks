...
public class TConstructRecipes {
		...
		private static void addToolCasting () {
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperShovelHead), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemShovelCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeShovelHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemShovelCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeShovelHead), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemShovelCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeShovelHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemShovelCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronShovelHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemShovelCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelShovelHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemShovelCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelShovelHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemShovelCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelShovelHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemShovelCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelShovelHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemShovelCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperProPickHead), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemProPickCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeProPickHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemProPickCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeProPickHead), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemProPickCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeProPickHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemProPickCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronProPickHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemProPickCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelProPickHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemProPickCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelProPickHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemProPickCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelProPickHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemProPickCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelProPickHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemProPickCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperHoeHead), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemHoeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeHoeHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemHoeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeHoeHead), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemHoeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeHoeHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemHoeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronHoeHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemHoeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelHoeHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemHoeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelHoeHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemHoeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelHoeHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemHoeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelHoeHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemHoeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperChiselHead), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemChiselCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeChiselHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemChiselCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeChiselHead), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemChiselCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeChiselHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemChiselCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronChiselHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemChiselCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelChiselHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemChiselCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelChiselHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemChiselCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelChiselHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemChiselCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelChiselHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemChiselCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperSwordHead), new FluidStack(WurmTweaksFluid.fluidCopper, 2000), WurmTweaksItems.itemSwordCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeSwordHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 2000), WurmTweaksItems.itemSwordCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeSwordHead), new FluidStack(WurmTweaksFluid.fluidBronze, 2000), WurmTweaksItems.itemSwordCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeSwordHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 2000), WurmTweaksItems.itemSwordCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronSwordHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.itemSwordCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelSwordHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.itemSwordCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelSwordHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 2000), WurmTweaksItems.itemSwordCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelSwordHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 2000), WurmTweaksItems.itemSwordCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelSwordHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 2000), WurmTweaksItems.itemSwordCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperMaceHead), new FluidStack(WurmTweaksFluid.fluidCopper, 2000), WurmTweaksItems.itemMaceCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeMaceHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 2000), WurmTweaksItems.itemMaceCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeMaceHead), new FluidStack(WurmTweaksFluid.fluidBronze, 2000), WurmTweaksItems.itemMaceCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeMaceHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 2000), WurmTweaksItems.itemMaceCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronMaceHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.itemMaceCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelMaceHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.itemMaceCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelMaceHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 2000), WurmTweaksItems.itemMaceCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelMaceHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 2000), WurmTweaksItems.itemMaceCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelMaceHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 2000), WurmTweaksItems.itemMaceCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperSawHead), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeSawHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeSawHead), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeSawHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronSawHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelSawHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelSawHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelSawHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelSawHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperJavelinHead), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemJavelinCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeJavelinHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemJavelinCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeJavelinHead), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemJavelinCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeJavelinHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemJavelinCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronJavelinHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemJavelinCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelJavelinHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemJavelinCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelJavelinHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemJavelinCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelJavelinHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemJavelinCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelJavelinHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemJavelinCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperHammerHead), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeHammerHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeHammerHead), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeHammerHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronHammerHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelHammerHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelHammerHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelHammerHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelHammerHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperKnifeHead), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemKnifeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeKnifeHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemKnifeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeKnifeHead), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemKnifeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeKnifeHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemKnifeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronKnifeHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemKnifeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelKnifeHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemKnifeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelKnifeHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemKnifeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelKnifeHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemKnifeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelKnifeHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemKnifeCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperScytheHead), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemScytheCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bismuthBronzeScytheHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemScytheCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeScytheHead), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemScytheCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeScytheHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemScytheCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.wroughtIronScytheHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemScytheCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.steelScytheHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemScytheCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelScytheHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemScytheCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelScytheHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemScytheCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blueSteelScytheHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemScytheCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.tuyereCopper), new FluidStack(WurmTweaksFluid.fluidCopper, 4000), WurmTweaksItems.itemTuyereCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.tuyereBismuthBronze), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 4000), WurmTweaksItems.itemTuyereCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.tuyereBronze), new FluidStack(WurmTweaksFluid.fluidBronze, 4000), WurmTweaksItems.itemTuyereCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.tuyereBlackBronze), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 4000), WurmTweaksItems.itemTuyereCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.tuyereWroughtIron), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 4000), WurmTweaksItems.itemTuyereCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.tuyereSteel), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 4000), WurmTweaksItems.itemTuyereCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.tuyereBlackSteel), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 4000), WurmTweaksItems.itemTuyereCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.tuyereRedSteel), new FluidStack(WurmTweaksFluid.fluidRedSteel, 4000), WurmTweaksItems.itemTuyereCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.tuyereBlueSteel), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 4000), WurmTweaksItems.itemTuyereCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModManager.CopperIceSawHead), new FluidStack(WurmTweaksFluid.fluidCopper, 2000), WurmTweaksItems.itemIceSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModManager.BismuthBronzeIceSawHead), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 2000), WurmTweaksItems.itemIceSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModManager.BronzeIceSawHead), new FluidStack(WurmTweaksFluid.fluidBronze, 2000), WurmTweaksItems.itemIceSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModManager.BlackBronzeIceSawHead), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 2000), WurmTweaksItems.itemIceSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModManager.WroughtIronIceSawHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.itemIceSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModManager.SteelIceSawHead), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.itemIceSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModManager.BlackSteelIceSawHead), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 2000), WurmTweaksItems.itemIceSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModManager.RedSteelIceSawHead), new FluidStack(WurmTweaksFluid.fluidRedSteel, 2000), WurmTweaksItems.itemIceSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModManager.BlueSteelIceSawHead), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 2000), WurmTweaksItems.itemIceSawCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemWarHammer_Copper_Head), new FluidStack(WurmTweaksFluid.fluidCopper, 2000), WurmTweaksItems.itemWarHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemWarHammer_BismuthBronze_Head), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 2000), WurmTweaksItems.itemWarHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemWarHammer_Bronze_Head), new FluidStack(WurmTweaksFluid.fluidBronze, 2000), WurmTweaksItems.itemWarHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemWarHammer_BlackBronze_Head), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 2000), WurmTweaksItems.itemWarHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemWarHammer_WroughtIron_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.itemWarHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemWarHammer_Steel_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.itemWarHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemWarHammer_BlackSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 2000), WurmTweaksItems.itemWarHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemWarHammer_RedSteel_Head), new FluidStack(WurmTweaksFluid.fluidRedSteel, 2000), WurmTweaksItems.itemWarHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemWarHammer_BlueSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 2000), WurmTweaksItems.itemWarHammerCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemPoniard_Copper_Head), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemPoniardCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemPoniard_BismuthBronze_Head), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemPoniardCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemPoniard_Bronze_Head), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemPoniardCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemPoniard_BlackBronze_Head), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemPoniardCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemPoniard_WroughtIron_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemPoniardCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemPoniard_Steel_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemPoniardCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemPoniard_BlackSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemPoniardCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemPoniard_RedSteel_Head), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemPoniardCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemPoniard_BlueSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemPoniardCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemHalberd_Copper_Head), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemHalberdCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemHalberd_BismuthBronze), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemHalberdCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemHalberd_Bronze_Head), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemHalberdCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemHalberd_BlackBronze_Head), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemHalberdCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemHalberd_WroughtIron_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemHalberdCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemHalberd_Steel_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemHalberdCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemHalberd_BlackSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemHalberdCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemHalberd_RedSteel_Head), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemHalberdCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemHalberd_BlueSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemHalberdCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemArrow_Copper_Head, 6), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemArrowHeadCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemArrow_BismuthBronze_Head, 6), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemArrowHeadCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemArrow_Bronze_Head, 6), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemArrowHeadCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemArrow_BlackBronze_Head, 6), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemArrowHeadCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemArrow_WroughtIron_Head, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemArrowHeadCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemArrow_Steel_Head, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemArrowHeadCast);
			...
			TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemBolt_Copper_Head, 6), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemBoltCast);
				...
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemBolt_WroughtIron_Head, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemBoltCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemBolt_Steel_Head, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemBoltCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemBolt_BlackSteel_Head, 6), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemBoltCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemBolt_RedSteel_Head, 6), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemBoltCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemBolt_BlueSteel_Head, 6), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemBoltCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemLink_Copper, 6), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemLinkCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemLink_BismuthBronze, 6), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemLinkCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemLink_Bronze, 6), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemLinkCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemLink_BlackBronze, 6), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemLinkCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemLink_WroughtIron, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemLinkCast);
				TConstructHelper.addCastingRecipe(new ItemStack(ModItems.itemLink_Steel, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemLinkCast);
