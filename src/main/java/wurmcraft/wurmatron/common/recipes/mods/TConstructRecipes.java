...
public class TConstructRecipes {
		...
		private static void addIngotCasting () {
				...
				addCastingWithReverse(new ItemStack(TFCItems.wroughtIronSheet2x), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.platinumIngot2x), new FluidStack(WurmTweaksFluid.fluidPlatinum, 2000), WurmTweaksItems.itemDoubleIngotCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.platinumSheet), new FluidStack(WurmTweaksFluid.fluidPlatinum, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.platinumSheet2x), new FluidStack(WurmTweaksFluid.fluidPlatinum, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.goldIngot2x), new FluidStack(WurmTweaksFluid.fluidGold, 2000), WurmTweaksItems.itemDoubleIngotCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.goldSheet), new FluidStack(WurmTweaksFluid.fluidGold, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.goldSheet2x), new FluidStack(WurmTweaksFluid.fluidGold, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.sterlingSilverIngot2x), new FluidStack(WurmTweaksFluid.fluidSterlingSilver, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.sterlingSilverSheet), new FluidStack(WurmTweaksFluid.fluidSterlingSilver, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.sterlingSilverSheet2x), new FluidStack(WurmTweaksFluid.fluidSterlingSilver, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.silverIngot2x), new FluidStack(WurmTweaksFluid.fluidSilver, 2000), WurmTweaksItems.itemDoubleIngotCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.silverSheet), new FluidStack(WurmTweaksFluid.fluidSilver, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.silverSheet2x), new FluidStack(WurmTweaksFluid.fluidSilver, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.blueSteelIngot2x), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.blueSteelSheet), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.blueSteelSheet2x), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.blackSteelIngot2x), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 2000), WurmTweaksItems.itemDoubleIngotCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackSteelSheet), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.blackSteelSheet2x), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.redSteelIngot2x), new FluidStack(WurmTweaksFluid.fluidRedSteel, 2000), WurmTweaksItems.itemDoubleIngotCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.redSteelSheet), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.redSteelSheet2x), new FluidStack(WurmTweaksFluid.fluidRedSteel, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.copperIngot2x), new FluidStack(WurmTweaksFluid.fluidCopper, 2000), WurmTweaksItems.itemDoubleIngotCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.copperSheet), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.copperSheet2x), new FluidStack(WurmTweaksFluid.fluidRedSteel, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.steelIngot2x), new FluidStack(WurmTweaksFluid.fluidSteel, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.steelSheet), new FluidStack(WurmTweaksFluid.fluidSteel, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.steelSheet2x), new FluidStack(WurmTweaksFluid.fluidSteel, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.bronzeIngot2x), new FluidStack(WurmTweaksFluid.fluidBronze, 2000), WurmTweaksItems.itemDoubleIngotCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.bronzeSheet), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.bronzeSheet2x), new FluidStack(WurmTweaksFluid.fluidBronze, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.bismuthIngot2x), new FluidStack(WurmTweaksFluid.fluidBismuth, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.bismuthSheet), new FluidStack(WurmTweaksFluid.fluidBismuth, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.bismuthSheet2x), new FluidStack(WurmTweaksFluid.fluidBismuth, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.bismuthBronzeIngot2x), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.bismuthBronzeSheet), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.bismuthBronzeSheet2x), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.blackBronzeIngot2x), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 2000), WurmTweaksItems.itemDoubleIngotCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.blackBronzeSheet), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.blackBronzeSheet2x), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.brassIngot2x), new FluidStack(WurmTweaksFluid.fluidBrass, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.brassSheet), new FluidStack(WurmTweaksFluid.fluidBrass, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.brassSheet2x), new FluidStack(WurmTweaksFluid.fluidBrass, 2000), WurmTweaksItems.item2xSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.leadIngot), new FluidStack(WurmTweaksFluid.fluidLead, 1000), new ItemStack(TinkerSmeltery.metalPattern, 1, 0));
				addCastingWithReverse(new ItemStack(TFCItems.leadIngot2x), new FluidStack(WurmTweaksFluid.fluidLead, 2000), WurmTweaksItems.itemDoubleIngotCast);
				TConstructHelper.addCastingRecipe(new ItemStack(TFCItems.leadSheet), new FluidStack(WurmTweaksFluid.fluidLead, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.leadSheet2x), new FluidStack(WurmTweaksFluid.fluidLead, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.nickelIngot2x), new FluidStack(WurmTweaksFluid.fluidNickel, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.nickelSheet), new FluidStack(WurmTweaksFluid.fluidNickel, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.nickelSheet2x), new FluidStack(WurmTweaksFluid.fluidNickel, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.pigIronIngot2x), new FluidStack(WurmTweaksFluid.fluidPigIron, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.pigIronSheet), new FluidStack(WurmTweaksFluid.fluidPigIron, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.pigIronSheet2x), new FluidStack(WurmTweaksFluid.fluidPigIron, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.roseGoldIngot2x), new FluidStack(WurmTweaksFluid.fluidRoseGold, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.roseGoldSheet), new FluidStack(WurmTweaksFluid.fluidRoseGold, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.roseGoldSheet2x), new FluidStack(WurmTweaksFluid.fluidRoseGold, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.zincIngot2x), new FluidStack(WurmTweaksFluid.fluidZinc, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.zincSheet), new FluidStack(WurmTweaksFluid.fluidZinc, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.zincSheet2x), new FluidStack(WurmTweaksFluid.fluidZinc, 2000), WurmTweaksItems.item2xSheetCast);
				...
				addCastingWithReverse(new ItemStack(TFCItems.tinIngot2x), new FluidStack(WurmTweaksFluid.fluidTin, 2000), WurmTweaksItems.itemDoubleIngotCast);
				addCastingWithReverse(new ItemStack(TFCItems.tinSheet), new FluidStack(WurmTweaksFluid.fluidTin, 1000), WurmTweaksItems.itemSheetCast);
				addCastingWithReverse(new ItemStack(TFCItems.tinSheet2x), new FluidStack(WurmTweaksFluid.fluidTin, 2000), WurmTweaksItems.item2xSheetCast);
