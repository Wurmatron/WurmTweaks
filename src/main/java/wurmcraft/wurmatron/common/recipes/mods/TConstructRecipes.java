...
public class TConstructRecipes {
		...
		private static void addCastingRecipes () {
				...
				addCastingWithReverse(new ItemStack(TFCMItems.itemWarHammer_Copper_Head), new FluidStack(WurmTweaksFluid.fluidCopper, 2000), WurmTweaksItems.itemWarHammerCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemWarHammer_BismuthBronze_Head), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 2000), WurmTweaksItems.itemWarHammerCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemWarHammer_Bronze_Head), new FluidStack(WurmTweaksFluid.fluidBronze, 2000), WurmTweaksItems.itemWarHammerCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemWarHammer_BlackBronze_Head), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 2000), WurmTweaksItems.itemWarHammerCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemWarHammer_WroughtIron_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.itemWarHammerCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemWarHammer_Steel_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 2000), WurmTweaksItems.itemWarHammerCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemWarHammer_BlackSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 2000), WurmTweaksItems.itemWarHammerCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemWarHammer_RedSteel_Head), new FluidStack(WurmTweaksFluid.fluidRedSteel, 2000), WurmTweaksItems.itemWarHammerCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemWarHammer_BlueSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 2000), WurmTweaksItems.itemWarHammerCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemPoniard_Copper_Head), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemPoniardCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemPoniard_BismuthBronze_Head), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemPoniardCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemPoniard_Bronze_Head), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemPoniardCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemPoniard_BlackBronze_Head), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemPoniardCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemPoniard_WroughtIron_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemPoniardCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemPoniard_Steel_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemPoniardCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemPoniard_BlackSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemPoniardCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemPoniard_RedSteel_Head), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemPoniardCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemPoniard_BlueSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemPoniardCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemHalberd_Copper_Head), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemHalberdCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemHalberd_BismuthBronze), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemHalberdCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemHalberd_Bronze_Head), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemHalberdCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemHalberd_BlackBronze_Head), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemHalberdCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemHalberd_WroughtIron_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemHalberdCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemHalberd_Steel_Head), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemHalberdCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemHalberd_BlackSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemHalberdCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemHalberd_RedSteel_Head), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemHalberdCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemHalberd_BlueSteel_Head), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemHalberdCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemArrow_Copper_Head, 6), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemArrowHeadCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemArrow_BismuthBronze_Head, 6), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemArrowHeadCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemArrow_Bronze_Head, 6), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemArrowHeadCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemArrow_BlackBronze_Head, 6), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemArrowHeadCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemArrow_WroughtIron_Head, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemArrowHeadCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemArrow_Steel_Head, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemArrowHeadCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemArrow_BlackSteel_Head, 6), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemArrowHeadCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemArrow_RedSteel_Head, 6), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemArrowHeadCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemArrow_BlueSteel_Head, 6), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemArrowHeadCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemBolt_Copper_Head, 6), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemBoltCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemBolt_BismuthBronze_Head, 6), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemBoltCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemBolt_Bronze_Head, 6), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemBoltCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemBolt_BlackBronze_Head, 6), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemBoltCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemBolt_WroughtIron_Head, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemBoltCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemBolt_Steel_Head, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemBoltCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemBolt_BlackSteel_Head, 6), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemBoltCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemBolt_RedSteel_Head, 6), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemBoltCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemBolt_BlueSteel_Head, 6), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemBoltCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemLink_Copper, 6), new FluidStack(WurmTweaksFluid.fluidCopper, 1000), WurmTweaksItems.itemLinkCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemLink_BismuthBronze, 6), new FluidStack(WurmTweaksFluid.fluidBismuthBronze, 1000), WurmTweaksItems.itemLinkCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemLink_Bronze, 6), new FluidStack(WurmTweaksFluid.fluidBronze, 1000), WurmTweaksItems.itemLinkCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemLink_BlackBronze, 6), new FluidStack(WurmTweaksFluid.fluidBlackBronze, 1000), WurmTweaksItems.itemLinkCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemLink_WroughtIron, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemLinkCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemLink_Steel, 6), new FluidStack(WurmTweaksFluid.fluidWroughtIron, 1000), WurmTweaksItems.itemLinkCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemLink_BlackSteel, 6), new FluidStack(WurmTweaksFluid.fluidBlackSteel, 1000), WurmTweaksItems.itemLinkCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemLink_RedSteel, 6), new FluidStack(WurmTweaksFluid.fluidRedSteel, 1000), WurmTweaksItems.itemLinkCast);
				addCastingWithReverse(new ItemStack(TFCMItems.itemLink_BlueSteel, 6), new FluidStack(WurmTweaksFluid.fluidBlueSteel, 1000), WurmTweaksItems.itemLinkCast);
