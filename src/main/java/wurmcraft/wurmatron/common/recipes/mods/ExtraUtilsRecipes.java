...
public class ExtraUtilsRecipes {
		...
		public static void addRecipes () {
				...
				GameRegistry.addRecipe(RecipeUnstableIngotCrafting.addRecipe(new ItemStack(ExtraUtils.unstableIngot), new Object[] {"I", "S", "D", Character.valueOf('I'), TFCItems.redSteelSheet, Character.valueOf('S'), ItemDivisionSigil.newActiveSigil(), Character.valueOf('D'), "packGemExquisite"}));
				GameRegistry.addRecipe((RecipeUnstableNuggetCrafting.addRecipe(new ItemStack(ExtraUtils.unstableIngot, 1, 1), new Object[] {"g", "S", "D", Character.valueOf('g'),TFCItems.blueSteelSheet, Character.valueOf('S'), ItemDivisionSigil.newActiveSigil(), Character.valueOf('D'), "packGemExquisite"})));
				ItemStack item = new ItemStack(ExtraUtils.unstableIngot);
				NBTTagCompound tags = new NBTTagCompound();
				tags.setBoolean("stable", true);
				item.setTagCompound(tags);
				GameRegistry.addRecipe(item, new Object[] {"uuu", "uuu", "uuu", Character.valueOf('u'), new ItemStack(ExtraUtils.unstableIngot, 1, 1)});
				for (int b = 1; b < 7; b++)
						r.add3X(new ItemStack(ExtraUtils.cobblestoneCompr, 1, b), new ItemStack(ExtraUtils.cobblestoneCompr, 1, b - 1));
