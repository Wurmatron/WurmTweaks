...
public class ExtraUtilsRecipes {
		...
		public static void addRecipes () {
				...
				GameRegistry.addRecipe(RecipeUnstableIngotCrafting.addRecipe(new ItemStack(ExtraUtils.unstableIngot), new Object[] {"I", "S", "D", Character.valueOf('I'), Items.iron_ingot, Character.valueOf('S'), ItemDivisionSigil.newActiveSigil(), Character.valueOf('D'), Items.diamond}));
				GameRegistry.addRecipe((RecipeUnstableNuggetCrafting.addRecipe(new ItemStack(ExtraUtils.unstableIngot, 1, 1), new Object[] {"g", "S", "D", Character.valueOf('g'), Items.gold_nugget, Character.valueOf('S'), ItemDivisionSigil.newActiveSigil(), Character.valueOf('D'), Items.diamond})));
